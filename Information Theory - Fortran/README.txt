==================================
Braghetto, Pompeo - 19/04/2020
Information Theory and Computation
FINAL PROJECT
==================================


In the ./Code folder there are all the files that make up the project we developed. 
Here we present a list with a brief description of the purpose of each - further details can be found in the documentation within the code itself or in the .pdf report.
...
The analysis can be run by typing 

python analysis.py 

on terminal. The script will ask the end-user a series of y/n questions:
